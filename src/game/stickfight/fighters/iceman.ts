...
export const ICEMAN: FighterDef = {
  ...
  moves: [
    ...
    // ----------------------------------------------------------------- super
    {
      ...
      meterCost: 100,
      superFreeze: 38,
      invuln: [{ from: 1, to: 26, kind: "strike" }],
      friction: 0.82,
      armor: [{ from: 8, to: 60, hits: 3, damageScale: 0.2 }],
      // He does not get stronger. He gets harder to finish, for a long time,
      // which is the only thing the record actually says about him.
      grants: [{ damageTaken: 0.62, frames: 600 }],
      hits: [hit(40, 46, bx(14, 14, 84, 80), 68, {
        fx: "blunt",
        pushX: 12,
        knockdown: "hard",
        hitstun: 24,
      ...
      vfx: [
        { at: 2, kind: "super", x: 0, y: 50, scale: 2.5, color: "#9fd8ea" },
        { at: 16, kind: "aura", x: 0, y: 46, scale: 2.4, color: "#9fd8ea" },
        { at: 40, kind: "explode", x: 42, y: 40, scale: 1.2, color: "#dff2f8" },
      ],
      desc: "SUPER. Plants himself and stops. For ten seconds he takes barely over half damage and shrugs off three hits outright - he does not hit harder for it, because being hard to finish is the only thing anyone ever established about him.",
      notation: "\u2193\u2193 + S (100 meter)",
      frames: [
        kf(0, { ...STANCE, crouch: 0.4, torso: -8 }, "out"),
        // Down into the ground, both hands, weight over the heels.
        kf(14, { ...STANCE, crouch: 0.78, torso: 26, head: 8, shoulderF: 10, elbowF: 40, weapon: -34, shoulderB: 100, elbowB: 20, hipF: 40, kneeF: 78, hipB: -34, kneeB: 84, offX: -2 }, "out"),
        kf(28, { ...STANCE, crouch: 0.72, torso: 22, head: 6, shoulderF: 14, elbowF: 44, weapon: -30, hipF: 38, kneeF: 74 }, "inOut"),
        // And then he simply stands up again, which is the whole point.
        kf(38, { ...STANCE, crouch: 0.16, torso: -12, head: 10, shoulderF: 30, elbowF: 56, weapon: -18, shoulderB: 160, elbowB: -62, offY: 2 }, "out"),
        kf(40, { ...STANCE, torso: 28, shoulderF: 86, elbowF: 6, weapon: -40, shoulderB: 70, elbowB: 20, hipF: 38, kneeF: 14, offX: 9 }, "out"),
        kf(58, { ...STANCE, torso: 14, shoulderF: 44, elbowF: 46, weapon: -24, offX: 3 }, "inOut"),
        kf(84, { ...STANCE }),
      ],
    },
  ],
