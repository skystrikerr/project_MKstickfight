...
export const NINJA: FighterDef = {
  ...
  moves: [
    ...
    // ----------------------------------------------------------------- super
    {
      ...
      // behind. It cannot: pushboxes are separated every frame, so he never
      // gets to the other side and the whole move whiffed into the back of
      ...
      vfx: [
        { at: 2, kind: "super", x: 0, y: 50, scale: 2.4, color: "#7a5ccf" },
        { at: 8, kind: "smoke", x: 0, y: 40, scale: 1.6 },
        { at: 34, kind: "smoke", x: 40, y: 40, scale: 1.6 },
      ...
      frames: [
        ...
        kf(18, { ...STANCE, free: 1, torso: 24, shoulderB: 62, elbowB: 10, weaponBack: 96, hipF: 40, kneeF: 50, offY: 4 }, "linear"),
        kf(28, { ...STANCE, free: 1, torso: 12, shoulderB: 40, elbowB: 40, weaponBack: 140, hipF: 26, kneeF: 40, offY: 2 }, "inOut"),
