...
export const KNIGHT: FighterDef = {
  ...
  moves: [
    ...
    // ----------------------------------------------------------------- super
    {
      ...
      duration: 88,
      meterCost: 100,
      // Most of a Vow, not all of it. Gating on a full bar sounds better than
      // it plays: it makes the move something you see once a match if the
      // round goes long, and content nobody meets is the fault this whole
      // pass exists to fix.
      resourceMin: 65,
      resourceCost: 65,
      superFreeze: 42,
      invuln: [{ from: 1, to: 16, kind: "strike" }],
      armor: [{ from: 10, to: 56, hits: 4, damageScale: 0.12 }],
      vel: [{ at: 10, x: 9 }, { at: 40, x: 6 }, { at: 60, x: 0 }],
      friction: 0.94,
      hits: [
      ...
      vfx: [
        { at: 2, kind: "super", x: 0, y: 50, scale: 2.5, color: "#e0c46a" },
        { at: 8, kind: "aura", x: 0, y: 48, scale: 1.8, color: "#e0c46a" },
        { at: 18, kind: "guardBreak", x: 60, y: 50, scale: 1.2 },
        { at: 52, kind: "explode", x: 54, y: 44, scale: 1.4, color: "#ffe9a8" },
      ],
      desc: "SUPER. Couches the lance and rides it in. The first hit takes the whole guard bar whether they block it or not - a lance is not a heavier sword, it is the answer to a shield - and the rest lands on a man with his arms down. Needs most of a Vow behind it.",
      notation: "\u2193\u2193 + S (100 meter, 65 Vow)",
      frames: [
        kf(0, { ...STANCE, crouch: 0.42, torso: -10 }, "out"),
        kf(10, { ...STANCE, torso: 22, shoulderF: 78, elbowF: 30, shoulderB: 84, elbowB: 6, weapon: 8, hipF: 32, kneeF: 12, offX: 5 }, "out"),
        // Couched: both hands, point level, weight behind it.
        kf(18, { ...STANCE, torso: 30, shoulderF: 86, elbowF: 2, shoulderB: 92, elbowB: -6, weapon: -6, hipF: 44, kneeF: 8, hipB: -40, kneeB: 16, offX: 11 }, "linear"),
        kf(24, { ...STANCE, torso: 32, shoulderF: 85, elbowF: -2, weapon: -5, hipF: 48, kneeF: 6, offX: 16 }, "out"),
        kf(36, { ...STANCE, torso: 20, shoulderF: 40, elbowF: 70, weapon: 60, offX: 6 }, "inOut"),
        kf(41, { ...STANCE, torso: 30, shoulderF: 100, elbowF: -8, weapon: -24, hipF: 40, kneeF: 12, offX: 12 }, "out"),
        kf(48, { ...STANCE, torso: -18, shoulderF: 168, elbowF: -22, weapon: -52, hipB: -34, kneeB: 44, offX: -4 }, "inOut"),
        kf(52, { ...STANCE, torso: 34, shoulderF: 74, elbowF: 2, weapon: -12, shoulderB: 68, elbowB: 8, hipF: 46, kneeF: 16, offX: 13 }, "out"),
        kf(70, { ...STANCE, torso: 14, shoulderF: 56, elbowF: 60, weapon: 46, offX: 4 }, "inOut"),
        kf(88, { ...STANCE }),
      ],
    },
  ],
