...
export const MUAYTHAI: FighterDef = {
  ...
  moves: [
    ...
    // ----------------------------------------------------------------- super
    {
      ...
      vel: [{ at: 4, x: 7.5 }, { at: 16, x: 0 }],
      friction: 0.9,
      throwDef: { from: 8, to: 18, range: 96, success: "superNine" },
      vfx: [{ at: 2, kind: "super", x: 0, y: 50, scale: 2.4, color: "#e0b050" }],
      desc: "SUPER. Takes the neck and does not give it back. Muay Thai is the art of eight limbs; there are nine strikes here, and the ninth is the one that should not be there.",
      notation: "\u2192\u2198\u2193\u2199\u2190 + S (100 meter)",
      frames: [
        kf(0, { ...STANCE, crouch: 0.4, torso: -6, offX: -4 }, "out"),
        kf(6, { ...STANCE, torso: 18, shoulderF: 98, elbowF: 34, shoulderB: 92, elbowB: 38, hipF: 30, offX: 6 }, "out"),
        kf(12, { ...STANCE, torso: 24, shoulderF: 88, elbowF: 16, shoulderB: 82, elbowB: 20, hipF: 36, kneeF: 12, offX: 10 }, "out"),
        kf(24, { ...STANCE, torso: 14, shoulderF: 60, elbowF: 80, offX: 3 }, "inOut"),
        kf(38, { ...STANCE }),
      ],
    },
    {
      ...
      throwPayload: {
        ...
        shake: 3.2,
        fx: "blunt",
        // Two knees, two elbows, two shins, two fists - and then the head,
        // which is the ninth and is not one of the eight.
        ticks: [
          { at: 10, damage: 22, fx: "blunt" },
          { at: 20, damage: 22, fx: "blunt" },
          { at: 32, damage: 24, fx: "slash" },
          { at: 42, damage: 24, fx: "slash" },
          { at: 54, damage: 22, fx: "blunt" },
          { at: 64, damage: 22, fx: "blunt" },
          { at: 76, damage: 20, fx: "blunt" },
          { at: 86, damage: 20, fx: "blunt" },
        ],
      },
      desc: "",
      frames: [
        kf(0, { ...STANCE, torso: 20, shoulderF: 88, elbowF: 16, shoulderB: 82, elbowB: 20 }, "out"),
        // Knees.
        kf(10, { ...STANCE, torso: 26, shoulderF: 86, elbowF: 14, shoulderB: 80, elbowB: 18, hipF: 110, kneeF: 110, offX: 3 }, "out"),
        kf(15, { ...STANCE, torso: 20, hipF: 28, kneeF: 28 }, "inOut"),
        kf(20, { ...STANCE, torso: 26, hipB: 106, kneeB: 106, offX: 3 }, "out"),
        kf(26, { ...STANCE, torso: 20, hipB: -18, kneeB: 28 }, "inOut"),
        // Elbows.
        kf(32, { ...STANCE, torso: 24, shoulderF: 132, elbowF: 128, head: 4, offX: 4 }, "out"),
        kf(37, { ...STANCE, torso: 18, shoulderF: 88, elbowF: 20 }, "inOut"),
        kf(42, { ...STANCE, torso: 24, shoulderB: 130, elbowB: 126, head: 4, offX: 4 }, "out"),
        kf(48, { ...STANCE, torso: 18, shoulderB: 84, elbowB: 22 }, "inOut"),
        // Shins.
        kf(54, { ...STANCE, torso: 12, hipF: 96, kneeF: 22, offX: 3 }, "out"),
        kf(59, { ...STANCE, torso: 18, hipF: 26, kneeF: 26 }, "inOut"),
        kf(64, { ...STANCE, torso: 12, hipB: 92, kneeB: 20, offX: 3 }, "out"),
        kf(70, { ...STANCE, torso: 18, hipB: -16, kneeB: 26 }, "inOut"),
        // Fists.
        kf(76, { ...STANCE, torso: 22, shoulderF: 96, elbowF: 4, offX: 5 }, "out"),
        kf(81, { ...STANCE, torso: 18, shoulderF: 40, elbowF: 110 }, "inOut"),
        kf(86, { ...STANCE, torso: 22, shoulderB: 94, elbowB: 4, offX: 5 }, "out"),
        kf(94, { ...STANCE, torso: 16, shoulderB: 22, elbowB: 112 }, "inOut"),
        // And the head.
        kf(104, { ...STANCE, torso: 34, head: 16, shoulderF: 30, elbowF: 96, shoulderB: 14, elbowB: 100, hipF: 40, kneeF: 10, offX: 9 }, "out"),
        kf(112, { ...STANCE, torso: 12, head: -2, offX: 3 }, "inOut"),
        kf(118, { ...STANCE }),
      ],
    },
  ],
