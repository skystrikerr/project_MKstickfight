...
export const SAMURAI: FighterDef = {
  ...
  moves: [
    ...
    },
    {
      ...
      frames: [
        kf(0, { ...STANCE }, "out"),
        kf(8, { ...STANCE, shoulderF: 158, elbowF: -44, weapon: 116, torso: -12, hipB: -30, kneeB: 48, offX: -6 }, "out"),
        kf(16, { ...STANCE, shoulderF: 62, elbowF: 34, weapon: 28, torso: 32, hipF: 40, kneeF: 16, hipB: -26, kneeB: 24, offX: 12 }, "out"),
        kf(24, { ...STANCE, shoulderF: 54, elbowF: 42, weapon: 24, torso: 24, hipF: 28, kneeF: 22, offX: 8 }),
