...
export const SAMURAI: FighterDef = {
  ...
  moves: [
    ...
    // ----------------------------------------------------------------- super
    {
      ...
      desc: "SUPER. Settles into the draw and waits. Catch a strike in the window and the answer is the whole hundred meter at once; catch nothing and you have paid for the privilege of standing still.",
    ...
    },
    {
      ...
      vfx: [
        { at: 5, kind: "super", x: 40, y: 52, scale: 1.8, color: "#ffffff" },
        { at: 7, kind: "explode", x: 74, y: 48, scale: 1.4, color: "#dfe6ee" },
      ],
      desc: "",
      frames: [
        kf(0, { ...STANCE, crouch: 0.44, torso: -14, shoulderF: 28, elbowF: 56, weapon: 42, offX: -5 }, "out"),
        // The draw and the cut are the same movement, which is the whole point
        // of the school - the blade is not raised first.
        kf(6, { ...STANCE, torso: 26, shoulderF: 92, elbowF: -8, shoulderB: 40, elbowB: 30, weapon: -30, hipF: 40, kneeF: 10, hipB: -34, kneeB: 20, offX: 12 }, "linear"),
        kf(11, { ...STANCE, torso: 30, shoulderF: 88, elbowF: -12, shoulderB: 36, elbowB: 34, weapon: -28, hipF: 44, kneeF: 8, offX: 20 }, "out"),
        // And the chiburi - the blood shaken off - before it goes back in.
        kf(26, { ...STANCE, torso: 8, shoulderF: 58, elbowF: 20, weapon: 4, offX: 6 }, "inOut"),
        kf(38, { ...STANCE, torso: 2, shoulderF: 40, elbowF: 44, weapon: 34 }, "inOut"),
        kf(54, { ...STANCE }),
      ],
    },
  ],
