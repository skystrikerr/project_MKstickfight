...
export const VIKING: FighterDef = {
  ...
  moves: [
    ...
    },
    {
      ...
      frames: [
        kf(0, { ...STANCE }, "out"),
        kf(5, { ...STANCE, shoulderB: -70, elbowB: 90, weaponBack: 223, torso: -8, offX: -4 }),
        kf(9, { ...STANCE, shoulderB: 92, elbowB: 8, weaponBack: 22, torso: 24, hipF: 30, kneeF: 20, offX: 7 }, "out"),
        kf(16, { ...STANCE, shoulderB: 66, elbowB: 30, weaponBack: -52, torso: 16 }, "inOut"),
        kf(24, { ...STANCE }),
      ],
    },
    {
    ...
    },
    {
      ...
      frames: [
        ...
        kf(5, { ...STANCE, crouch: 0.7, shoulderB: -40, elbowB: 96, weaponBack: -21, torso: 14 }),
        kf(9, { ...STANCE, torso: -16, shoulderB: 162, elbowB: -14, weaponBack: 3, hipF: 22, kneeF: 12, offY: 4 }, "out"),
        kf(18, { ...STANCE, torso: -10, shoulderB: 150, elbowB: -8, weaponBack: 81 }),
    ...
    },
    {
      ...
      frames: [
        kf(0, { ...STANCE }, "out"),
        kf(8, { ...STANCE, shoulderB: 176, elbowB: -30, weaponBack: 459, torso: -14, hipB: -32, kneeB: 50, offX: -6 }, "out"),
        // The whole arc comes over the top and through them.
        kf(16, { ...STANCE, shoulderB: 84, elbowB: 22, weaponBack: 13, torso: 32, hipF: 42, kneeF: 18, hipB: -26, kneeB: 24, offX: 12 }, "out"),
        kf(24, { ...STANCE, shoulderB: 72, elbowB: 30, weaponBack: -60, torso: 24, hipF: 30, kneeF: 24, offX: 8 }),
    ...
    },
    {
      ...
      frames: [
        ...
        kf(4, { ...STANCE, free: 1, shoulderB: -60, elbowB: 96, weaponBack: 208, torso: -10 }),
        kf(7, { ...STANCE, free: 1, shoulderB: 98, elbowB: 14, weaponBack: 10, torso: 22, hipF: 36, kneeF: 34 }, "out"),
        kf(17, { ...STANCE, free: 1, shoulderB: 74, elbowB: 30, weaponBack: -59, torso: 14 }, "inOut"),
        kf(25, { ...STANCE, free: 1 }),
      ],
    },
    {
