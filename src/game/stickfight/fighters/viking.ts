...
export const VIKING: FighterDef = {
  ...
  moves: [
    ...
    // ----------------------------------------------------------------- super
    {
      ...
      friction: 0.8,
      // Nothing for the rest of the round has to go through her. She hits
      ...
      vfx: [
        { at: 2, kind: "super", x: 0, y: 50, scale: 2.6, color: "#c94f3d" },
        { at: 22, kind: "aura", x: 0, y: 52, scale: 2.2, color: "#c94f3d" },
        { at: 30, kind: "explode", x: 46, y: 44, scale: 1.3, color: "#ffb08a" },
      ],
      desc: "SUPER. Takes the flat of the axe to her own chest and stops retreating. For the rest of the round she hits a third harder and takes a fifth more - there is no way to give it back, so press it while you are losing.",
      notation: "\u2193\u2193 + S (100 meter)",
      frames: [
        kf(0, { ...STANCE, crouch: 0.4, torso: -10 }, "out"),
        // The blow to her own chest.
        kf(12, { ...STANCE, crouch: 0.2, torso: -14, head: 8, shoulderB: 92, elbowB: 30, weaponBack: 40, shoulderF: 24, elbowF: 70, offX: -3 }, "out"),
        kf(18, { ...STANCE, crouch: 0.1, torso: 6, head: 2, shoulderB: 34, elbowB: 88, weaponBack: 96, shoulderF: 30, elbowF: 64, offY: 1, offX: 1 }, "out"),
        // Up, and roaring.
        kf(26, { ...STANCE, crouch: 0, torso: -18, head: 14, shoulderB: 168, elbowB: -70, weaponBack: 124, shoulderF: 150, elbowF: -20, hipF: 8, kneeF: 6, hipB: -12, kneeB: 16, offY: 3 }, "out"),
        // And straight into whoever was closest.
        kf(30, { ...STANCE, torso: 30, shoulderB: 66, elbowB: -6, weaponBack: 46, shoulderF: 40, elbowF: 40, hipF: 40, kneeF: 12, hipB: -34, kneeB: 26, offX: 10 }, "out"),
        kf(48, { ...STANCE, torso: 16, shoulderB: 130, elbowB: -40, weaponBack: 96, offX: 4 }, "inOut"),
        kf(74, { ...STANCE }),
      ],
    },
  ],
