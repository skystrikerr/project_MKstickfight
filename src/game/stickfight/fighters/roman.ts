...
export const ROMAN: FighterDef = {
  ...
  moves: [
    ...
    },
    {
      ...
      cancelWindow: [20, 36],
      hits: [
        hit(16, 20, bx(18, 22, 64, 68), 88, { fx: "blunt", guard: "mid", pushX: 17, hitstun: 24, hitstop: 12, knockdown: "wallbounce", shake: 2.2 }),
      ],
    ...
    },
    {
      ...
      cancelWindow: [26, 40],
      hits: [
        hit(20, 23, bx(14, 20, 70, 86), 100, { fx: "blunt", guard: "overhead", pushX: 9, hitstun: 28, hitstop: 13, knockdown: "hard", shake: 2.4 }),
      ],
