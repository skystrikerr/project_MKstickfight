...
export const PERSIAN: FighterDef = {
  ...
  moves: [
    ...
    // ---------------------------------------------------------------- normals
    {
      ...
      frames: [
        kf(0, { ...STANCE }, "out"),
        kf(4, { ...STANCE, shoulderB: 88, elbowB: -6, weaponBack: -6, torso: 16, hipF: 26, offX: 6 }),
        kf(9, { ...STANCE, shoulderB: 66, elbowB: 26, weaponBack: -4, torso: 8, offX: 2 }, "inOut"),
        kf(13, { ...STANCE }),
      ],
    },
    {
      ...
      frames: [
        kf(0, { ...STANCE }, "out"),
        // Draws back along the shaft's own line rather than cocking it up.
        kf(4, { ...STANCE, shoulderB: 34, elbowB: 62, weaponBack: 8, torso: -8, offX: -4 }),
        kf(8, { ...STANCE, shoulderB: 82, elbowB: 0, weaponBack: -4, torso: 18, hipF: 30, offX: 8 }, "out"),
        kf(14, { ...STANCE, shoulderB: 66, elbowB: 26, weaponBack: -6, torso: 10, offX: 3 }, "inOut"),
        kf(21, { ...STANCE }),
      ],
    },
    {
    ...
    },
    {
      ...
      frames: [
        kf(0, { ...STANCE, crouch: 1, torso: 16, hipF: 34, kneeF: 78, hipB: -24, kneeB: 88 }, "out"),
        kf(4, { ...STANCE, crouch: 1, torso: 8, hipF: 34, kneeF: 78, hipB: -24, kneeB: 88, shoulderB: 30, elbowB: 60, weaponBack: -28 }),
        kf(8, { ...STANCE, crouch: 1, torso: 26, hipF: 44, kneeF: 84, hipB: -24, kneeB: 88, shoulderB: 58, elbowB: -6, weaponBack: -8, offX: 9 }, "out"),
        kf(15, { ...STANCE, crouch: 1, torso: 20, hipF: 34, kneeF: 78, hipB: -24, kneeB: 88, shoulderB: 48, elbowB: 30, weaponBack: -28 }, "inOut"),
    ...
    },
    {
      ...
      frames: [
        ...
        kf(4, { ...STANCE, free: 1, shoulderB: 26, elbowB: 66, weaponBack: 4, torso: -6 }),
        kf(8, { ...STANCE, free: 1, shoulderB: 68, elbowB: -6, weaponBack: 10, torso: 18, hipF: 38 }, "out"),
        kf(16, { ...STANCE, free: 1, shoulderB: 56, elbowB: 30, weaponBack: -2, torso: 6 }, "inOut"),
        kf(24, { ...STANCE, free: 1 }),
      ],
    },
    {
    ...
    },
    {
      ...
      frames: [
        kf(0, { ...STANCE }, "out"),
        kf(3, { ...STANCE, torso: 22, crouch: 0.4, shoulderB: 28, elbowB: 66, weaponBack: -20, offX: -3 }),
        kf(8, { ...STANCE, torso: 28, crouch: 0.3, shoulderB: 84, elbowB: -4, weaponBack: -12, hipF: 44, kneeF: 24, offX: 9 }, "out"),
        kf(21, { ...STANCE, torso: 14, shoulderB: 62, elbowB: 32, weaponBack: -12, offX: 3 }, "inOut"),
        kf(31, { ...STANCE }),
      ],
    },
