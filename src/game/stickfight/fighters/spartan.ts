...
export const SPARTAN: FighterDef = {
  ...
  moves: [
    ...
    },
    {
      // Forward set -----------------------------------------------------
      //
      // A is the aspis, B is the dory, C commits. Forward advances and takes
      // space; back gives it up to gain range or a hard read. Every one of
      // these is a string component first and a move second.
      id: "6A",
      name: "Rim Jab",
      ...
      frames: [
        kf(0, { ...STANCE }, "out"),
        kf(4, { ...STANCE, shoulderF: 56, elbowF: 74, torso: 2, offX: -2 }, "out"),
        kf(7, { ...STANCE, shoulderF: 84, elbowF: 6, torso: 16, hipF: 26, kneeF: 18, offX: 7 }, "out"),
        kf(12, { ...STANCE, shoulderF: 76, elbowF: 22, torso: 12, offX: 5 }, "inOut"),
        kf(20, { ...STANCE }),
      ],
    },
    {
      ...
      desc: "The shove of the phalanx - whole body behind the shield. Carries them to the wall.",
      notation: "\u2192 + C",
      frames: [
        kf(0, { ...STANCE }, "out"),
        kf(8, { ...STANCE, torso: -12, shoulderF: 50, elbowF: 84, hipB: -34, kneeB: 56, crouch: 0.3, offX: -6 }, "out"),
        kf(16, { ...STANCE, torso: 34, shoulderF: 78, elbowF: 30, hipF: 44, kneeF: 20, hipB: -30, kneeB: 26, crouch: 0.16, offX: 12 }, "out"),
        kf(24, { ...STANCE, torso: 26, shoulderF: 70, elbowF: 38, hipF: 32, kneeF: 26, offX: 8 }),
    ...
    },
    {
      ...
      vel: [{ at: 1, x: -2.6 }],
      friction: 0.86,
      hits: [hit(8, 10, bx(18, 54, 42, 30), 38, { fx: "blunt", guard: "mid", pushX: 6, hitstun: 15, hitstop: 6 })],
      desc: "Gives ground and puts the rim in the way. Catches anyone walking in behind a whiff.",
      notation: "\u2190 + A",
      frames: [
        kf(0, { ...STANCE }, "out"),
        kf(4, { ...STANCE, torso: -6, shoulderF: 48, elbowF: 76, hipB: -26, kneeB: 40, offX: -6 }, "out"),
        kf(8, { ...STANCE, torso: 4, shoulderF: 72, elbowF: 20, hipF: 22, kneeF: 20, offX: -3 }, "out"),
        kf(14, { ...STANCE, torso: 0, shoulderF: 64, elbowF: 42, offX: -4 }, "inOut"),
        kf(22, { ...STANCE }),
      ],
    },
    {
      id: "4B",
      name: "Withdrawn Thrust",
      ...
      frames: [
        kf(0, { ...STANCE }, "out"),
        kf(6, { ...STANCE, shoulderB: 132, elbowB: -70, weaponBack: 38, torso: -12, hipB: -30, kneeB: 46, offX: -8 }, "inOut"),
        kf(12, { ...STANCE, shoulderB: 104, elbowB: 0, weaponBack: 2, torso: 6, hipF: 30, kneeF: 14, hipB: -24, kneeB: 34, offX: -5 }, "out"),
        kf(17, { ...STANCE, shoulderB: 102, elbowB: 2, weaponBack: 2, torso: 4, hipF: 28, kneeF: 14, offX: -6 }),
        kf(23, { ...STANCE, shoulderB: 116, elbowB: -38, weaponBack: 22, torso: 2, offX: -4 }, "inOut"),
        kf(30, { ...STANCE }),
      ],
    },
    {
      ...
      cancelInto: ["special", "super"],
      cancelWindow: [26, 40],
      // Turns the dory over and brings the bronze butt-spike down from above -
      ...
      desc: "Turns the dory over and drives the butt-spike down. Overhead - has to be blocked standing.",
      notation: "\u2190 + C",
      frames: [
        kf(0, { ...STANCE }, "out"),
        kf(8, { ...STANCE, shoulderB: 148, elbowB: -80, weaponBack: 120, torso: -10, offX: -5 }, "inOut"),
        // Spear inverted overhead, butt leading.
        kf(15, { ...STANCE, shoulderB: 186, elbowB: -30, weaponBack: 196, torso: -18, hipB: -28, kneeB: 40, offY: 3, offX: -3 }, "out"),
        kf(20, { ...STANCE, shoulderB: 116, elbowB: 10, weaponBack: 208, torso: 30, hipF: 34, kneeF: 20, hipB: -14, kneeB: 34, offX: 6 }, "out"),
        kf(26, { ...STANCE, shoulderB: 106, elbowB: 16, weaponBack: 208, torso: 24, offX: 4 }),
        kf(36, { ...STANCE, shoulderB: 122, elbowB: -20, weaponBack: 90, torso: 10 }, "inOut"),
        kf(44, { ...STANCE }),
      ],
    },
    {
    ...
    // ----------------------------------------------------------------- super
    {
      ...
      // The othismos: the shove. A phalanx did not fence, it leaned, and the
      // line that leaned harder walked over the other one.
      //
      // It was five hits and a launcher, which is what fourteen of the
      // twenty-three supers were - a longer version of a combo. As a grab it
      // is a different question entirely: it goes through a guard, so the
      // answer to a Spartan sitting on a hundred meter is no longer "block",
      // and "come and take them" is finally something he does to you.
      vel: [{ at: 4, x: 8 }, { at: 18, x: 0 }],
      friction: 0.9,
      throwDef: { from: 8, to: 20, range: 92, success: "superShove" },
      vfx: [{ at: 2, kind: "super", x: 0, y: 50, scale: 2.4, color: "#c8452f" }],
      desc: "SUPER. Locks the aspis into them and leans. Unblockable, and it does not stop until one of you is against the wall.",
      notation: "\u2192\u2198\u2193\u2199\u2190 + S (100 meter)",
      frames: [
        kf(0, { ...STANCE, crouch: 0.5, torso: -6, offX: -4 }, "out"),
        kf(6, { ...STANCE, crouch: 0.34, torso: 22, shoulderF: 40, elbowF: 74, hipF: 34, kneeF: 14, offX: 5 }, "out"),
        kf(12, { ...STANCE, crouch: 0.26, torso: 30, shoulderF: 26, elbowF: 88, shoulderB: 96, elbowB: 8, hipF: 44, kneeF: 10, hipB: -40, kneeB: 22, offX: 10 }, "out"),
        kf(24, { ...STANCE, torso: 18, shoulderF: 46, elbowF: 66, offX: 4 }, "inOut"),
        kf(40, { ...STANCE }),
      ],
    },
    {
      ...
      duration: 96,
      grabOffset: [46, 2],
      // Carried the whole way. The damage is mostly in the wall at the end,
      // because the shove is the move and the wall is what it is for.
      vel: [{ at: 2, x: 6.2 }, { at: 62, x: 0 }],
      friction: 0.98,
      throwPayload: {
        at: 74,
        damage: 152,
        ...
        fx: "blunt",
        ticks: [
          { at: 14, damage: 20, fx: "blunt" },
          { at: 30, damage: 20, fx: "blunt" },
          { at: 46, damage: 22, fx: "blunt" },
          { at: 60, damage: 22, fx: "blunt" },
        ],
      },
      desc: "",
      frames: [
        kf(0, { ...STANCE, crouch: 0.3, torso: 30, shoulderF: 26, elbowF: 88, shoulderB: 96, elbowB: 8, offX: 8 }, "out"),
        kf(20, { ...STANCE, crouch: 0.36, torso: 34, shoulderF: 20, elbowF: 94, shoulderB: 92, elbowB: 10, hipF: 48, kneeF: 8, hipB: -44, kneeB: 20, offX: 10 }, "linear"),
        kf(46, { ...STANCE, crouch: 0.32, torso: 32, shoulderF: 22, elbowF: 92, shoulderB: 94, elbowB: 8, hipF: 40, kneeF: 12, hipB: -46, kneeB: 18, offX: 11 }, "linear"),
        kf(62, { ...STANCE, crouch: 0.38, torso: 36, shoulderF: 18, elbowF: 96, hipF: 50, kneeF: 6, offX: 12 }, "out"),
        // The spear, finally, into whatever the wall left of them.
        kf(74, { ...STANCE, crouch: 0.1, torso: 26, shoulderF: 30, elbowF: 70, shoulderB: 46, elbowB: 4, weaponBack: -8, hipF: 34, kneeF: 14, offX: 14 }, "out"),
        kf(86, { ...STANCE, torso: 14, offX: 5 }, "inOut"),
        kf(96, { ...STANCE }),
      ],
    },
  ],
