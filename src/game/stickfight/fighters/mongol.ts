...
export const MONGOL: FighterDef = {
  ...
  moves: [
      ...
      projectiles: [
        {
          ...
          // Pierces one target and keeps going; it does not hit them thrice.
          hits: 1,
          clashes: false,
          fx: "pierce",
          scale: 1.15,
    ...
    // ----------------------------------------------------------------- super
    {
      ...
      friction: 0.9,
      projectiles: [
        // Three flat arrows, faster and faster, then the one she aimed.
        //
        // It was six at `hits: 3` and a seventh at `hits: 6` - up to
        // twenty-four hits on a single opponent inside about a second, which
        // is what "supers doing too many hits" looked like from the other end
        // of it. Each arrow now lands once, for what an arrow is worth, and
