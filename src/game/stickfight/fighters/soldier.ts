...
export const SOLDIER: FighterDef = {
  ...
  moves: [
    ...
    },
    {
      ...
      duration: 58,
      friction: 0.86,
      // Costs no ammunition - it is a radio, not a rifle - and he cannot move
      // or defend himself for most of a second while he makes the call.
      projectiles: [
        {
          at: 30,
          kind: "grenade",
      ...
      vfx: [
        { at: 6, kind: "spark", x: 10, y: 60, scale: 0.7, color: "#8fd0ff" },
        { at: 30, kind: "spark", x: 14, y: 62, scale: 0.7, color: "#8fd0ff" },
      ],
      desc: "The call that goes out when a position is about to be overrun: everything in range comes, and comes close. It lands well out in front of him, so it answers whoever is keeping their distance - and it costs no ammunition, only the second he spends on the handset unable to do anything else.",
      notation: "↓↘→ + B",
      frames: [
        kf(0, { ...STANCE }, "out"),
        // Handset up, weight down, other hand flat on the deck.
        kf(8, { ...STANCE, crouch: 0.72, torso: 22, head: 8, shoulderF: 12, elbowF: 34, shoulderB: 128, elbowB: 96, hipF: 36, kneeF: 76, hipB: -30, kneeB: 84, offX: -3 }, "out"),
        kf(30, { ...STANCE, crouch: 0.74, torso: 24, head: 10, shoulderF: 10, elbowF: 30, shoulderB: 132, elbowB: 100, hipF: 38, kneeF: 78, offX: -3 }, "inOut"),
        kf(44, { ...STANCE, crouch: 0.5, torso: 14, shoulderB: 80, elbowB: 60, hipF: 28, kneeF: 54 }, "inOut"),
        kf(58, { ...STANCE }),
      ],
    },
    {
