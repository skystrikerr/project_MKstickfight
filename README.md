...
npm run get:exe v0.3.5 # a specific tagged release instead
```
...
npm run dist:win       # -> release/Stick Fighter-0.3.5-x64.exe   (needs Windows)
npm run dist:linux     # -> release/Stick Fighter-0.3.5-x64.AppImage
npm run dist:mac       # -> release/Stick Fighter-0.3.5-x64.dmg   (needs macOS)
```
